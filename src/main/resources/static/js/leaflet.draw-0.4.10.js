 ...
 */
!function (t, e, i) {
    L.drawVersion = "0.4.10", L.Draw = {}, L.drawLocal = {
        draw: {
            toolbar: {
        ...
        _drawGuide: function (t, e) {
            ...
            for (this._guidesContainer || (this._guidesContainer = L.DomUtil.create("div", "leaflet-draw-guides", this._overlayPane)); l < s; l += this.options.guidelineDistance) i = l / s, o = {
        ...
        _getMeasurementString: function () {
            ...
            return t = i && e && e.distanceTo ? this._measurementRunningTotal + e.distanceTo(i) : this._measurementRunningTotal || 0, L.GeometryUtil.readableDistance(t, this.options.metric, this.options.feet, this.options.nautic, this.options.precision)
        },
        ...
        _getTooltipText: function () {
            ...
            return n && (t = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(), e = L.GeometryUtil.geodesicArea(t), i = s ? L.GeometryUtil.readableArea(e, this.options.metric) : ""), {
                text: o.text,
                subtext: i
            }
        }
        ...
        _onMouseMove: function (t) {
            ...
            if (this._tooltip.updatePosition(i), this._isDrawing) {
                ...
                var s = "";
                o && (s = L.drawLocal.draw.handlers.circle.radius + ": " + L.GeometryUtil.readableDistance(e, n, this.options.feet, this.options.nautic)), this._tooltip.updateContent({
        ...
        _createMoveMarker: function () {
            ...
            this._shape.setLatLngs(s), this._repositionCornerMarkers(), this._map.fire(L.Draw.Event.EDITMOVE, {layer: this._shape})
        }, _resize: function (t) {
            var e;
        ...
        _createMoveMarker: function () {
            ...
            this._resizeMarkers[0].setLatLng(e), this._shape.setLatLng(t), this._map.fire(L.Draw.Event.EDITMOVE, {layer: this._shape})
        }, _resize: function (t) {
            var e = this._moveMarker.getLatLng(), i = e.distanceTo(t);
            this._shape.setRadius(i), this._map.fire(L.Draw.Event.EDITRESIZE, {layer: this._shape})
        }
        ...
        L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
            geodesicArea: function (t) {
                ...
                var i = t.toFixed(e), o = L.drawLocal.format && L.drawLocal.format.numeric, n = o && o.delimiters,
                    s = n && n.thousands, a = n && n.decimal;
                if (s || a) {
                    var r = i.split(".");
                ...
                var n, s, o = L.Util.extend({}, t, o);
                return i ? (s = ["ha", "m"], type = typeof i, "string" === type ? s = [i] : "boolean" !== type && (s = i), n = e >= 1e6 && -1 !== s.indexOf("km") ? L.GeometryUtil.formattedNumber(1e-6 * e, o.km) + " km²" : e >= 1e4 && -1 !== s.indexOf("ha") ? L.GeometryUtil.formattedNumber(1e-4 * e, o.ha) + " ha" : L.GeometryUtil.formattedNumber(e, o.m) + " m²") : (e /= .836127, n = e >= 3097600 ? L.GeometryUtil.formattedNumber(e / 3097600, o.mi) + " mi²" : e >= 4840 ? L.GeometryUtil.formattedNumber(e / 4840, o.ac) + " acres" : L.GeometryUtil.formattedNumber(e, o.yd) + " yd²"), n
            }, readableDistance: function (e, i, o, n, s) {
                var a, s = L.Util.extend({}, t, s);
                switch (i ? "string" == typeof i ? i : "metric" : o ? "feet" : n ? "nauticalMile" : "yards") {
                    ...
                    case"yards":
                    default:
                        e *= 1.09361, a = e > 1760 ? L.GeometryUtil.formattedNumber(e / 1760, s.mi) + " miles" : L.GeometryUtil.formattedNumber(e, s.yd) + " yd"
                }
                return a
            }
        })
        ...
        includes: [L.Mixin.Events], initialize: function (t) {
            ...
            return e.href = "#", e.appendChild(i), t.title && (e.title = t.title, i.innerHTML = t.title), t.text && (e.innerHTML = t.text, i.innerHTML = t.text), L.DomEvent.on(e, "click", L.DomEvent.stopPropagation).on(e, "mousedown", L.DomEvent.stopPropagation).on(e, "dblclick", L.DomEvent.stopPropagation).on(e, "touchstart", L.DomEvent.stopPropagation).on(e, "click", L.DomEvent.preventDefault).on(e, "click", t.callback, t.context), e
        }, _disposeButton: function (t, e) {
            L.DomEvent.off(t, "click", L.DomEvent.stopPropagation).off(t, "mousedown", L.DomEvent.stopPropagation).off(t, "dblclick", L.DomEvent.stopPropagation).off(t, "touchstart", L.DomEvent.stopPropagation).off(t, "click", L.DomEvent.preventDefault).off(t, "click", e)
            ...
            for (var l = 0; l < r; l++) "enabled" in a[l] && !a[l].enabled || (e = L.DomUtil.create("li", "", s), n = this._createButton({
                title: a[l].title,
                text: a[l].text,
                container: e,
