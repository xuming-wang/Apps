...
import org.air.bigearth.apps.file.domain.UploadInfo;
...
public class FileUploadUtil {
	...
	public String upload(HttpServletRequest request, MultipartFile[] myfiles, String fileT, String modelCode)
			throws Exception {
	...
	public String upload(HttpServletRequest request, MultipartFile myfile, String fileT, String modelCode)
			throws Exception {
		//DataFile dataFile = new DataFile();
		String realPath = request.getSession().getServletContext().getRealPath(File.separator);
		System.out.println("1--" + realPath);
	...
	/**
	 *  取得tomcat中的webapps目录 如： /home/gzxiaoi/apache-tomcat-8.0.45/webapps
	 * @param request
	 * @return
	 */
	...
	private static void mergeFile(int chunksNumber, String ext, String guid, String uploadFolderPath,
		...
		String destPath = LocalFileConstants.LOCAL_SCP_DIR;
