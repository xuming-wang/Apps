...
//        }
        ...
        //String fileName = "/run/media/centos/disk/system/cn_windows_7_ultimate_with_sp1_x64_dvd_u_677408.iso";
        //String fileName = "/run/media/centos/CentOS 7 x8/LC08_L1TP_029024_20150312_20170301_01_T1.tar.gz";
        String fileName = "/run/media/centos/disk/Install Packages/Java/Myeclipse/myeclipse-10.0.2-offline-installer-windows.exe";//c5c8f7abc4d8e8bc2d9d343b2764f045
////        String fileName = "E:\\SoTowerStudio-3.1.0.exe";
//        String hashType = "MD5";
//        String hash = getHash(fileName,hashType);
//        System.out.println("MD5:"+hash);//e706a56bc638ebfb531235723f2cfe09
        String s = FileMD5Util.getFileMD5(new File(fileName));//35bf5b7a488330a9e42a95838aa1c2ee
